...
public class VisitorController {
    ...
    VisitorDto create(@RequestBody VisitorDto visitorDto) {
    ...
    @PutMapping("/{id}")
    VisitorDto makeFriend(@RequestBody String friendId,
    ...
    List<PerformanceProjection> getRecommendations(@PathVariable String id) {
